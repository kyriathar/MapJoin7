...
public class StringManipulation {
    ...
    public static String new_header(String line, String keys, String separator) throws Exception
    {
	String header;
	if (keys != separator)
    ...
    public static String Intersection(String s1, String s2, String separator) throws Exception
    {
        // Get two strings and return their common words.
        // strings s1 and s2 must contain spaces between words.
        // words must be sorted lexicographically from smaller to bigger values. No duplicates.
	...
	String unique_columns2 = separator;
        ...
        return keys + ";" + keys2 + ";" + unique_columns + ";" + unique_columns2;
    }
